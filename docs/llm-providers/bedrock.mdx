---
title: "AWS Bedrock"
description: "Configure SDeVPro with models via AWS Bedrock"
---

## Installation

Bedrock requires the AWS SDK dependency. Install SDeVPro with the bedrock extra:

```bash
pipx install "sdevpro-agent[bedrock]"
```
