---
title: "Overview"
description: "Configure your AI model for SDeVPro"
---

SDeVPro uses [LiteLLM](https://docs.litellm.ai/docs/providers) for model compatibility, supporting 100+ LLM providers.
