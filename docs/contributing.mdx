---
title: "Contributing"
description: "Contribute to SDeVPro development"
---
...
Skills are specialized knowledge packages that enhance agent capabilities. They live in `sdevpro/skills/`
...
the sidecar as `sdevpro/bin/sdevpro-tui`, and assigns the current platform tag.
Frozen releases built by `scripts/build.sh` and `sdevpro.spec` also require the
sidecar.
...
- SDeVPro version (`sdevpro --version`)
- LLM being used
...
<CardGroup cols={2}>
  <Card title="Discord" icon="discord" href="https://github.com/SamirGroup/SDeVPro">
    Join the community for help and discussion.
  </Card>
  <Card title="GitHub Issues" icon="github" href="https://github.com/SamirGroup/SDeVPro/issues">
