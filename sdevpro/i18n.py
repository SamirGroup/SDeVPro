...
_TR: dict[str, dict[str, str]] = {
    "uz": {
        ...
        "schedule_choose_prompt": "\"{target}\" uchun tekshiruv qachon avtomatik ishga tushsin?",
        "schedule_btn_30m": "Har 30 daqiqada",
        "schedule_btn_1h": "Har soatda",
        "schedule_btn_3h": "Har 3 soatda",
        "schedule_btn_6h": "Har 6 soatda",
        "schedule_btn_12h": "Har 12 soatda",
        "schedule_btn_daily": "Har kuni, aniq vaqtda",
        "schedule_choose_daily_time": "\"{target}\" uchun kunlik hisobot qaysi vaqtda (UTC) yuborilsin?",
        "schedule_daily_set": "Kunlik tekshiruv o'rnatildi: {target}\nHar kuni soat {time} (UTC) da avtomatik hisobot yuboriladi.",
        "schedule_custom_hint": "Yoki aniq interval kiriting: /schedule {target} 2h30m",
        ...
        "sig_sqli": "SQL Injection urinishi",
        "sig_traversal": "Path traversal / LFI urinishi",
        "sig_xss": "XSS urinishi",
        "sig_cmdi": "Command injection urinishi",
        "sig_wp_bruteforce": "WordPress admin/login brute-force",
        "sig_sensitive_path": "Maxfiy fayl/konfiguratsiya izlash",
        "sig_scanner_ua": "Ma'lum zaiflik skaneri User-Agent'i",
        "sig_admin_probe": "Admin panel/boshqaruv paneli izlash",
    },
    "ru": {
        "choose_language": "Tilni tanlang / Выберите язык / Choose language:",
        ...
        "schedule_choose_prompt": "Когда автоматически запускать проверку для \"{target}\"?",
        "schedule_btn_30m": "Каждые 30 минут",
        "schedule_btn_1h": "Каждый час",
        "schedule_btn_3h": "Каждые 3 часа",
        "schedule_btn_6h": "Каждые 6 часов",
        "schedule_btn_12h": "Каждые 12 часов",
        "schedule_btn_daily": "Ежедневно, в точное время",
        "schedule_choose_daily_time": "В какое время (UTC) присылать ежедневный отчёт для \"{target}\"?",
        "schedule_daily_set": "Ежедневная проверка установлена: {target}\nОтчёт будет приходить каждый день в {time} (UTC).",
        "schedule_custom_hint": "Или укажите точный интервал: /schedule {target} 2h30m",
        ...
        "sig_sqli": "Попытка SQL Injection",
        "sig_traversal": "Попытка Path traversal / LFI",
        "sig_xss": "Попытка XSS",
        "sig_cmdi": "Попытка command injection",
        "sig_wp_bruteforce": "Перебор пароля WordPress admin/login",
        "sig_sensitive_path": "Поиск конфиденциальных файлов/конфигурации",
        "sig_scanner_ua": "User-Agent известного сканера уязвимостей",
        "sig_admin_probe": "Поиск панели администратора",
    },
    "en": {
        "choose_language": "Tilni tanlang / Выберите язык / Choose language:",
        ...
        "schedule_choose_prompt": "When should automatic checks run for \"{target}\"?",
        "schedule_btn_30m": "Every 30 minutes",
        "schedule_btn_1h": "Every hour",
        "schedule_btn_3h": "Every 3 hours",
        "schedule_btn_6h": "Every 6 hours",
        "schedule_btn_12h": "Every 12 hours",
        "schedule_btn_daily": "Daily, at a specific time",
        "schedule_choose_daily_time": "What time (UTC) should the daily report for \"{target}\" be sent?",
        "schedule_daily_set": "Daily scan set: {target}\nA report will be sent automatically every day at {time} (UTC).",
        "schedule_custom_hint": "Or specify an exact interval: /schedule {target} 2h30m",
        ...
        "sig_sqli": "SQL Injection attempt",
        "sig_traversal": "Path traversal / LFI attempt",
        "sig_xss": "XSS attempt",
        "sig_cmdi": "Command injection attempt",
        "sig_wp_bruteforce": "WordPress admin/login brute-force",
        "sig_sensitive_path": "Probing for sensitive files/configuration",
        "sig_scanner_ua": "Known vulnerability scanner User-Agent",
        "sig_admin_probe": "Admin panel probing",
    },
}
