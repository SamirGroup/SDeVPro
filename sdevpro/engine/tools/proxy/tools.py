...
from sdevpro.engine.tools.proxy import caido_api
...
if TYPE_CHECKING:
    ...
    from sdevpro.engine.tools.proxy.caido_api import (
        RequestPart,
        SitemapDepth,
        SortBy,
        SortOrder,
    ...
    from sdevpro.engine.tools.proxy.caido_api import (  # noqa: TC001
        RequestPart,
        SitemapDepth,
        SortBy,
        SortOrder,
