...
from sdevpro.engine.report.sarif import write_sarif
...
class ReportState:
    ...
    persistence. This store keeps only SDeVPro-owned scan artifacts and
...
class StreamedOpenRouterCosts:
    ...
    scan streams, so the OpenRouter streaming handler (see sdevpro.engine.config.models)
