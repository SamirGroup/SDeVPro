...
class StrixDockerSandboxClient(DockerSandboxClient):
    ...
    async def _create_container(
        ...
        *,
        ...
        # SDeVPro delta from the SDK body: drop ``entrypoint`` override and
        ...
        # SDeVPro injections — append, don't overwrite, so FUSE/SYS_ADMIN survives.
        ...
        # SDeVPro injection: local source trees, sorted shallowest-first so a
