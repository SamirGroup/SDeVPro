"""Execution loop for addressable SDK-backed SDeVPro agents."""
...
from sdevpro.engine.core.inputs import child_initial_input
from sdevpro.engine.core.sessions import (
...
from sdevpro.engine.llm.compaction import is_context_overflow, maybe_compact
...
if TYPE_CHECKING:
    ...
    from sdevpro.engine.core.agents import AgentCoordinator, Status
