...
& $venvPython -m pip install -q litellm requests reportlab "python-telegram-bot[job-queue]>=21.6" dnspython beautifulsoup4 python-dotenv
...
Write-Host "  1. .env faylini to'ldiring (TELEGRAM_BOT_TOKEN, SDEVPRO_LLM, SDEVPRO_LLM_API_KEY)"
