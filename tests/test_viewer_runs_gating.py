...
from sdevpro.engine.interface.viewer.server import build_runs_payload, resolve_run_dir
...
def test_runs_payload_empty_base(tmp_path: Path) -> None:
    payload = build_runs_payload(tmp_path / "sdevpro_runs", verified=True)
