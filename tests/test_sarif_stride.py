"""STRIDE-leg tagging in the SARIF emitter (sdevpro.engine.report.sarif).
...
from sdevpro.engine.report.sarif import (
    _CWE_TO_STRIDE,
...
def test_stride_tags_attach_to_rule_not_duplicated_on_result() -> None:
    ...
    its own sdevpro.engine.* properties, not a redundant tags copy."""
